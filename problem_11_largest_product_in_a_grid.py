...
matrix_1 = ["08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08",
...
matrix_2 = [[8, 2, 22, 97, 38, 15, 0, 40, 0, 75, 4, 5, 7, 78, 52, 12, 50, 77, 91, 8],
...
if __name__ == "__main__":
    ...
    print("Time of execution for summation_3: ", time() - start)
